...
import { runTest as Test, runTestQuickPick as QuickPick, Options, runWithCustomTemplate } from './runner'
...
describe('Single line template tests', () => {
  ...
  Test('await template - nested in awaited call     | await getFoo(getBaz(){await}) >> await getFoo(await getBaz())')
